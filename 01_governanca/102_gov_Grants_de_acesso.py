...
# MAGIC
# MAGIC
# MAGIC https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/security-grant
...
# MAGIC %sql
# MAGIC
# MAGIC GRANT CREATE ON SCHEMA my_schema TO `alf@melmak.et`;
# MAGIC
# MAGIC GRANT ALL PRIVILEGES ON TABLE forecasts TO finance;
# MAGIC
# MAGIC GRANT SELECT ON TABLE sample_data TO `alf@melmak.et`;
# MAGIC
